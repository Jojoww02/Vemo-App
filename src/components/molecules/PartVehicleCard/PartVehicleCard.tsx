    ...
    <div className="w-full flex xl:w-[30rem] h-[6.7rem] xl:h-[7rem] xl:px-5 xl:p-2 px-2 p-2 my-2 rounded-[0.50rem] bg-white shadow-[0px_2px_7px_5px_#00000040] cursor-pointer">
      ...
      <div className="relative flex flex-col px-5 w-full font-semibold text-dark">
        ...
        <p className="font-normal text-base xl:text-lg ">Kondisi {title} Motor</p>
          <input type="checkbox" className="absolute top-2 right-8 border-hidden rounded-full h-5 w-5 cursor-pointer" onChange={onCheckboxChange} checked={checked} />
          <button type="button" className="absolute right-5 xs:right-6 top-8 bg-primary px-3 py-1 rounded-xl text-[8px] md:text-xs text-white">
            Edit
          </button>

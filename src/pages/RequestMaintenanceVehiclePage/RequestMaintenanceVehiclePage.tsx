...
import RequestMaintenanceVehicleMobilePage from "@/mobile/RequestMaintenanceVehiclePageMobile/RequestMaintenanceVehicleMobilePage";
  ...
  return (
    <>
      {isMobile ? (
        ...
        <RequestMaintenanceVehicleMobilePage />
      )}
    </>
  );
}

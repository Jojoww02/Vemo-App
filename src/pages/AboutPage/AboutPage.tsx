  ...
  return (
    ...
    <div className="px-4">
      <div className="text-center text-white bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-800 px-6 py-6 leading-8 flex flex-col gap-4 overflow-x-auto">
        ...
        <p className="text-xs xs:text-base font-thin sm:text-xl">Kami rasa, kami dapat membantu user dalam mempermudahnya melalui aplikasi web ini. Misi kami adalah menyediakan perangkat lunak berfitur lengkap, semuanya berjalan lancar untuk setiap user.</p>
      </div>
      ...
      <div className="px-6  ">
        ...
        <div className="font-normal text-sm flex flex-col  leading-5  gap-5">
          ...
          <p className="xs:text-base sm:text-xl">
            Memberikan pengalaman baru dalam pengembangan aplikasi dengan cara yang sangat berbeda sebelumnya yaitu mengembangkan aplikasi bagi user yang ingin merawat kendaraannya melalui aplikasi online sehingga tidak perlu lagi mencari-cari
            bengkel yang jaraknya mungkin jauh.
          </p>
        </div>
      ...
      <div className="bg-[#1E232C] px-4 -z-10 text-white text-[11px] font-thin w-full pb-5">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="">
            ...
            <ul className="leading-8 text-[10px] xs:leading-9 sm:leading-10 xs:text-xs sm:text-base hover:bg-primary">
              <li>Index</li>
          ...
          <div className="">
            ...
            <div className="flex gap-2 sm:gap-4 py-2 ">
              <IconBrandFacebook style={{ height: "20px" }} className="hover:bg-primary" />
              <IconBrandGithubFilled style={{ height: "20px" }} className="hover:bg-primary"/>
              <IconBrandInstagram style={{ height: "20px" }} className="hover:bg-primary"/>
              <IconBrandWhatsapp style={{ height: "20px" }} className="hover:bg-primary"/>
            </div>
          </div>
        </div>
      </div>

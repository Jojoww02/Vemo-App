      ...
      {isSuccess && notification ? (
        <>
          <div className="flex flex-col">
            ...
            />
            <h1 className="lg:mt-10 mt-4 font-semibold text-xl lg:text-2xl">
              {notification.title}
            </h1>
            <button
              type="button"
              className="flex items-center justify-center font-regular rounded-lg bg-primary text-white text-1xl w-[4rem] h-[2rem] mt-5 cursor-default"
            >
              Inbox
            </button>
          </div>
          <div className="flex flex-row mt-8 items-center">
            ...
            <p className="px-5 font-extralight text-base lg:text-lg">
              Mail dari {notification.category} •{" "}
          ...
          <div className="rounded-xl p-4 py-5 pb-6 mt-5 relative rounded-l-lg bg-[#E8ECF4]">
            <h2 className="font-regular text-base lg:text-lg">

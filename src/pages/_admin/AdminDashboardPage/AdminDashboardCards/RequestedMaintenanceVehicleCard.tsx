...
export default function RequestedMaintenanceVehicleCard() {
  ...
  const data2 = [
    ...
    { name: "Permintaan Perawatan", value2: isSuccess ? (data as ICountVehiclesResponse).requested: 0, color: "#94a3b8" },
  ];
  return (
    <Card className="h-full">
      <h1 className="text-xl font-semibold text-center mt-8">Requsted Maintenance</h1>
      <CardContent>
        <div className="w-full">
          <PieChart width={250} height={200}>
            <Tooltip contentStyle={{ background: "white", borderRadius: "5px" }} />
            <Pie data={data2} cx={125} cy={160} startAngle={180} endAngle={0} innerRadius={60} outerRadius={80} fill="#8884d8" paddingAngle={5} dataKey="value2" label>

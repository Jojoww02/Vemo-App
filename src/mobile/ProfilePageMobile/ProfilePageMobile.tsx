...
import { CHANGE_PASSWORD_PAGE, CONFIRMATION_PASSWORD_PAGE, DASHBOARD_PAGE } from "@/lib/constants/routes";
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-4 mt-5 text-center relative sm:mt-4 ">
        ...
        <Link to={CONFIRMATION_PASSWORD_PAGE} style={{ display: "flex", alignItems: "center", gap: "8px" }}>
